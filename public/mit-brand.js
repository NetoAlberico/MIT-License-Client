...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      "#mitBrandOverlay input[type=text],#mitBrandOverlay input[type=file]{width:100%;background:#1c1f26;border:1px solid #40444f;color:#e9e6df;border-radius:5px;padding:7px 9px;font-size:13px;margin-bottom:12px;box-sizing:border-box;}",
